...
%% Setup Color Scheme for Light/Dark Options
    ...
    ecmd = sol.white;  % Set 'Error text' color in commend window 
...
%% Command windows error text
com.mathworks.services.Prefs.setColorPref('Color_CmdWinErrors', java.awt.Color(ecmd(1), ecmd(2), ecmd(3)));
