...
The **Late submission policy** allows **the maximum one-week delay for two among eight assignments.** Students do not need to inform their TAs for their delayed submission as well as the reason for the delay. TAs will just count the number of delays in your homework assignments. TAs will inform the students who delay their submissions two times. If the number of delays is more than two, the third delayed homework will be zero. Students must pay close attention to deadlines. 

Unless there are significant health issues that may cause students to not submit their assignments on time more than two times, students should contact both the First-Year Engineering Office and the instructor and sufficiently explain why they are not able to submit **all three homework assignments** on time. Thus, **please do not waste two chances for delay submission.** Again, **no late submission is accepted**, and any missed homework will be given a grade of 0. There is no exception.  
