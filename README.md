...
* You can ddebug your own program
* You can use built-in functions and understand how it works. Ultimately, you can write your own code to replicating their function. 
* You can express same opertation in various ways.  
